    ...
    <div className="mx-auto max-w-xl">
      <header className="page-header mb-6 flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h1 className="text-lg font-bold text-zinc-900">闪卡</h1>
          {card.note_title && (
            <Link
        ...
        <div className="space-y-3 rounded-2xl border border-zinc-200 bg-white p-5">
          <label className="block">
            ...
            <input
              ...
              autoFocus
              className="w-full rounded-lg border border-zinc-200 px-3 py-2.5 text-sm focus:border-teal-500 focus:outline-none"
            />
          </label>
          <label className="block">
            <span className="mb-1 block text-xs font-medium text-zinc-500">
          ...
          <div className="flex gap-3 text-sm">
            <button
              onClick={saveEdit}
              disabled={busy}
              className="rounded-lg bg-teal-600 px-4 py-2.5 font-semibold text-white transition-colors hover:bg-teal-700 disabled:opacity-60"
            >
              保存
            </button>
            <button
              onClick={() => setEditing(false)}
              className="rounded-lg px-4 py-2.5 text-zinc-500 hover:text-zinc-700"
            >
              取消
            </button>
          </div>
        ...
        <>
          ...
          <div className="mt-4 flex gap-2">
            <button
              ...
              className="flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-zinc-200 px-4 py-2.5 text-sm text-zinc-600 transition-colors hover:bg-zinc-50"
            >
